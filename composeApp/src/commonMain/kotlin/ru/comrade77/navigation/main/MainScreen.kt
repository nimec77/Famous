...
fun MainScreen() {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        BottomNavigation(
            modifier = Modifier.align(Alignment.BottomCenter).fillMaxWidth().height(bottomNavigationHeight),
            ...
            items.forEach { screen ->
                ...
                BottomNavigationItem(
                    ...
                    selectedContentColor = FamousTheme.colors.tintColor,
                    unselectedContentColor = FamousTheme.colors.secondaryText
                )
            }
        }
    }
